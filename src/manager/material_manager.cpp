...
MaterialManager::MaterialManager() {
    ...
    unlit_pipeline_desc.layout.attrs[ATTR_vs_normal].format = SG_VERTEXFORMAT_FLOAT3;
    ...
    unlit_material.uniform_transform_slot = static_cast<uint8_t>(unlit_uniformblock_slot(SG_SHADERSTAGE_VS, "transform_params"));
